...
use routes::{
    anonymous_beta_signup, authenticated_beta_signup, clear_puzzle_cache, create_games,
    create_issue, get_game, get_games, get_history, get_profile, get_puzzle_by_date, get_puzzles,
...
async fn main() -> std::io::Result<()> {
    ...
    let beta_signup_rate_limiter = web::Data::new(RateLimiter::new());
    ...
    let server = HttpServer::new(move || {
        ...
        if let Some(ref auth0) = auth0_service {
            ...
            app = app
                ...
                .service(authenticated_beta_signup);
            ...
            if github_issue_service.is_some() {
                app = app
                    .app_data(beta_signup_rate_limiter.clone())
                    .service(anonymous_beta_signup);
            }
        }
